This repository is where I've kept all my work in coding for my engineering and AP Computer Science classes.  Thus, it shows basically everything I've done, from the messy beginnings to the more polished steps of learning.  For example, in the LearningPythonTheHardWay folder, you'll see everything from the first exercise where I didn't know what "print" was, to the last.  The same goes for the APCS folder — I'm still implementing my knowledge of classes and better organization, but I am surely learning. When I organized this to show to the world, I kept all of the messy beginnings. 
